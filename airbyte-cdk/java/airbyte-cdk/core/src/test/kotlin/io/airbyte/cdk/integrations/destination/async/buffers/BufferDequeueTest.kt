...
class BufferDequeueTest {
    ...
    internal inner class Take {
        ...
        internal fun testTakeShouldBestEffortRead() {
            ...
            bufferEnqueue.addRecord(RECORD_MSG_20_BYTES, RECORD_SIZE_20_BYTES, DEFAULT_NAMESPACE)
            bufferEnqueue.addRecord(RECORD_MSG_20_BYTES, RECORD_SIZE_20_BYTES, DEFAULT_NAMESPACE)
            bufferEnqueue.addRecord(RECORD_MSG_20_BYTES, RECORD_SIZE_20_BYTES, DEFAULT_NAMESPACE)
            bufferEnqueue.addRecord(RECORD_MSG_20_BYTES, RECORD_SIZE_20_BYTES, DEFAULT_NAMESPACE)
    ...
    internal fun testMetadataOperationsCorrect() {
        ...
        bufferEnqueue.addRecord(recordFromSecondStream, RECORD_SIZE_20_BYTES, DEFAULT_NAMESPACE)
    ...
    internal fun cleansUpMemoryForEmptyQueues() {
        ...
        assertEquals(GlobalMemoryManager.BLOCK_SIZE_BYTES, globalMemoryManager.currentMemoryBytes.get())
