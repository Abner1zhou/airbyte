...
class RunningSizeEstimateTest {
    ...
    internal fun testEstimateWorkerWithBatch() {
        ...
        every { runningFlushWorkers.getSizesOfRunningWorkerBatches(any()) } returns listOf(Optional.of(SIZE_20MB))
    ...
    internal fun testEstimateWorkerWithoutBatchAndQueueLessThanOptimalSize() {
        ...
        every { runningFlushWorkers.getSizesOfRunningWorkerBatches(any()) } returns listOf(Optional.empty())
