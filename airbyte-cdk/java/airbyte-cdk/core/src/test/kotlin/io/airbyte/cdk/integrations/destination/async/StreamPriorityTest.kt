...
class StreamPriorityTest {
    ...
    internal fun testOrderByPrioritySize() {
        ...
        every { bufferDequeue.getQueueSizeBytes(DESC1) } returns Optional.of(1L) andThen Optional.of(0L)
        every { bufferDequeue.getQueueSizeBytes(DESC2) } returns Optional.of(0L) andThen Optional.of(1L)
    ...
    internal fun testOrderByPrioritySecondarySortByTime() {
        ...
        every { bufferDequeue.getTimeOfLastRecord(DESC1) } returns Optional.of(FIVE_MIN_AGO) andThen Optional.of(NOW)
        every { bufferDequeue.getTimeOfLastRecord(DESC2) } returns Optional.of(NOW) andThen Optional.of(FIVE_MIN_AGO)
